...
public class BlockStateProperties {
   ...
   public static final DirectionProperty FACING_HOPPER = DirectionProperty.create("facing", (p_208125_0_) -> {
   ...
   public static final EnumProperty<WallHeight> EAST_WALL = EnumProperty.create("east", WallHeight.class);
   public static final EnumProperty<WallHeight> NORTH_WALL = EnumProperty.create("north", WallHeight.class);
   public static final EnumProperty<WallHeight> SOUTH_WALL = EnumProperty.create("south", WallHeight.class);
   public static final EnumProperty<WallHeight> WEST_WALL = EnumProperty.create("west", WallHeight.class);
