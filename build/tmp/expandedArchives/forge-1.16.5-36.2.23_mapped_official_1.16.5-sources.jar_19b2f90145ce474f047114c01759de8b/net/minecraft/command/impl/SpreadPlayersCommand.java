...
public class SpreadPlayersCommand {
   ...
   static class Position {
      ...
      public int getSpawnY(IBlockReader p_198710_1_, int p_198710_2_) {
         ...
         boolean flag2;
         for(boolean flag1 = p_198710_1_.getBlockState(blockpos$mutable).isAir(); blockpos$mutable.getY() > 0; flag1 = flag2) {
            blockpos$mutable.move(Direction.DOWN);
            flag2 = p_198710_1_.getBlockState(blockpos$mutable).isAir();
            if (!flag2 && flag1 && flag) {
