      ...
      for(int l1 = k; l1 <= k + j1; ++l1) {
         for(int i2 = i1; i2 <= i1 + j1; ++i2) {
            if (l <= p_241855_1_.getHeight(Heightmap.Type.OCEAN_FLOOR_WG, l1, i2)) {
               return this.doPlace(p_241855_1_, p_241855_3_, p_241855_5_, d0, d1, d2, d3, d4, d5, k, l, i1, j1, k1);
            }
         }
      }
                        ...
                        for(int k2 = i1; k2 <= l1; ++k2) {
                           ...
                           if (d8 * d8 + d9 * d9 + d10 * d10 < 1.0D) {
                              ...
                              if (!bitset.get(l2)) {
                                 ...
                                 if (p_207803_3_.target.test(p_207803_1_.getBlockState(blockpos$mutable), p_207803_2_)) {
