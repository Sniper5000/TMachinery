...
public class OceanRuinConfig implements IFeatureConfig {
   public static final Codec<OceanRuinConfig> CODEC = RecordCodecBuilder.create((p_236563_0_) -> {
      return p_236563_0_.group(OceanRuinStructure.Type.CODEC.fieldOf("biome_temp").forGetter((p_236565_0_) -> {
         return p_236565_0_.biomeTemp;
