...
public class ItemLoreComponentizeFix extends DataFix {
            ...
            return p_219836_0_.update(DSL.remainderFinder(), (p_219835_0_) -> {
               return p_219835_0_.update("display", (p_219833_0_) -> {
                  return p_219833_0_.update("Lore", (p_219834_0_) -> {
                     return DataFixUtils.orElse(p_219834_0_.asStreamOpt().map(ItemLoreComponentizeFix::fixLoreList).map(p_219834_0_::createList).result(), p_219834_0_);
                  });
               });
            });
         });
   ...
   private static <T> Stream<Dynamic<T>> fixLoreList(Stream<Dynamic<T>> p_219830_0_) {
      return p_219830_0_.map((p_219831_0_) -> {
         return DataFixUtils.orElse(p_219831_0_.asString().map(ItemLoreComponentizeFix::fixLoreEntry).map(p_219831_0_::createString).result(), p_219831_0_);
      });
   }
