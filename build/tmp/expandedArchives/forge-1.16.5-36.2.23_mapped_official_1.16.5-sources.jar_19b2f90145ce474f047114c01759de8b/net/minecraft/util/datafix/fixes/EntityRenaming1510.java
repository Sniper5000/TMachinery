...
public class EntityRenaming1510 extends TypedEntityRenameHelper {
   ...
   public EntityRenaming1510(Schema p_i49651_1_, boolean p_i49651_2_) {
      super("EntityTheRenameningBlock", p_i49651_1_, p_i49651_2_);
   }

   protected String rename(String p_211311_1_) {
      if (p_211311_1_.startsWith("minecraft:bred_")) {
         p_211311_1_ = "minecraft:" + p_211311_1_.substring("minecraft:bred_".length());
      }
