...
public class V2502 extends NamespacedSchema {
   ...
   protected static void registerMob(Schema p_233463_0_, Map<String, Supplier<TypeTemplate>> p_233463_1_, String p_233463_2_) {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema p_registerEntities_1_) {
      ...
      registerMob(p_registerEntities_1_, map, "minecraft:hoglin");
      return map;
   }
}