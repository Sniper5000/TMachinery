...
public class V1801 extends NamespacedSchema {
   ...
   protected static void registerMob(Schema p_219878_0_, Map<String, Supplier<TypeTemplate>> p_219878_1_, String p_219878_2_) {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema p_registerEntities_1_) {
      ...
      registerMob(p_registerEntities_1_, map, "minecraft:illager_beast");
      return map;
   }
}