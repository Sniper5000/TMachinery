...
public class V1928 extends NamespacedSchema {
   ...
   protected static TypeTemplate equipment(Schema p_219884_0_) {
   ...
   protected static void registerMob(Schema p_219883_0_, Map<String, Supplier<TypeTemplate>> p_219883_1_, String p_219883_2_) {
      p_219883_0_.register(p_219883_1_, p_219883_2_, () -> {
         return equipment(p_219883_0_);
      });
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema p_registerEntities_1_) {
      ...
      registerMob(p_registerEntities_1_, map, "minecraft:ravager");
      return map;
   }
}