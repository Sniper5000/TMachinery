...
public class RedstoneConnections extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("RedstoneConnectionsFix", schema.getType(TypeReferences.BLOCK_STATE), (p_233367_1_) -> {
         return p_233367_1_.update(DSL.remainderFinder(), this::updateRedstoneConnections);
      });
   }

   private <T> Dynamic<T> updateRedstoneConnections(Dynamic<T> p_233368_1_) {
   ...
   private static boolean isConnected(String p_233369_0_) {
