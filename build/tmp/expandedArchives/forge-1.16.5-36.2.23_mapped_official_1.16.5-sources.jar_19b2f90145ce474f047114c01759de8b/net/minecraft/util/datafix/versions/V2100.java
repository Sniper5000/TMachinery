...
public class V2100 extends NamespacedSchema {
   ...
   protected static void registerMob(Schema p_226217_0_, Map<String, Supplier<TypeTemplate>> p_226217_1_, String p_226217_2_) {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema p_registerEntities_1_) {
      ...
      registerMob(p_registerEntities_1_, map, "minecraft:bee");
      registerMob(p_registerEntities_1_, map, "minecraft:bee_stinger");
      return map;
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema p_registerBlockEntities_1_) {
      ...
      p_registerBlockEntities_1_.register(map, "minecraft:beehive", () -> {
         return DSL.optionalFields("Items", DSL.list(TypeReferences.ITEM_STACK.in(p_registerBlockEntities_1_)), "Bees", DSL.list(DSL.optionalFields("EntityData", TypeReferences.ENTITY_TREE.in(p_registerBlockEntities_1_))));
      });
      return map;
   }
}