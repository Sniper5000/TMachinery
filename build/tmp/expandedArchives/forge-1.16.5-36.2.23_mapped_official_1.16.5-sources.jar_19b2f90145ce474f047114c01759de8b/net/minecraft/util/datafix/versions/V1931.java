...
public class V1931 extends NamespacedSchema {
   ...
   protected static void registerMob(Schema p_219888_0_, Map<String, Supplier<TypeTemplate>> p_219888_1_, String p_219888_2_) {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema p_registerEntities_1_) {
      ...
      registerMob(p_registerEntities_1_, map, "minecraft:fox");
      return map;
   }
}