...
public class V2568 extends NamespacedSchema {
   ...
   protected static void registerMob(Schema p_242270_0_, Map<String, Supplier<TypeTemplate>> p_242270_1_, String p_242270_2_) {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema p_registerEntities_1_) {
      ...
      registerMob(p_registerEntities_1_, map, "minecraft:piglin_brute");
      return map;
   }
}