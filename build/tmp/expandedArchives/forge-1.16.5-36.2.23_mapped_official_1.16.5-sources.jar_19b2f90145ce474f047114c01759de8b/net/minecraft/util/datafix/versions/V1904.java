...
public class V1904 extends NamespacedSchema {
   ...
   protected static void registerMob(Schema p_219876_0_, Map<String, Supplier<TypeTemplate>> p_219876_1_, String p_219876_2_) {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema p_registerEntities_1_) {
      ...
      registerMob(p_registerEntities_1_, map, "minecraft:cat");
      return map;
   }
}