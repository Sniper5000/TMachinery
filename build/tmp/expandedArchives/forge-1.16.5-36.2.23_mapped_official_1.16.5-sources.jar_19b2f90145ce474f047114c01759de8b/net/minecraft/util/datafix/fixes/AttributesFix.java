...
public class AttributesFix extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return TypeRewriteRule.seq(this.fixTypeEverywhereTyped("Rename ItemStack Attributes", type, (p_233071_1_) -> {
         return p_233071_1_.updateTyped(opticfinder, AttributesFix::fixItemStackTag);
      }), this.fixTypeEverywhereTyped("Rename Entity Attributes", this.getInputSchema().getType(TypeReferences.ENTITY), AttributesFix::fixEntity), this.fixTypeEverywhereTyped("Rename Player Attributes", this.getInputSchema().getType(TypeReferences.PLAYER), AttributesFix::fixEntity));
   }

   private static Dynamic<?> fixName(Dynamic<?> p_233073_0_) {
      return DataFixUtils.orElse(p_233073_0_.asString().result().map((p_233074_0_) -> {
         return RENAMES.getOrDefault(p_233074_0_, p_233074_0_);
      }).map(p_233073_0_::createString), p_233073_0_);
   }

   private static Typed<?> fixItemStackTag(Typed<?> p_233072_0_) {
         ...
         return p_233081_0_.update("AttributeModifiers", (p_233082_0_) -> {
            return DataFixUtils.orElse(p_233082_0_.asStreamOpt().result().map((p_233078_0_) -> {
               return p_233078_0_.map((p_233083_0_) -> {
                  return p_233083_0_.update("AttributeName", AttributesFix::fixName);
               });
   ...
   private static Typed<?> fixEntity(Typed<?> p_233076_0_) {
         ...
         return p_233077_0_.update("Attributes", (p_233079_0_) -> {
            return DataFixUtils.orElse(p_233079_0_.asStreamOpt().result().map((p_233075_0_) -> {
               return p_233075_0_.map((p_233080_0_) -> {
                  return p_233080_0_.update("Name", AttributesFix::fixName);
               });
