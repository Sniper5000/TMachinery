...
public class V2522 extends NamespacedSchema {
   ...
   protected static void registerMob(Schema p_233471_0_, Map<String, Supplier<TypeTemplate>> p_233471_1_, String p_233471_2_) {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema p_registerEntities_1_) {
      ...
      registerMob(p_registerEntities_1_, map, "minecraft:zoglin");
      return map;
   }
}