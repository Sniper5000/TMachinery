...
public class V2519 extends NamespacedSchema {
   ...
   protected static void registerMob(Schema p_233469_0_, Map<String, Supplier<TypeTemplate>> p_233469_1_, String p_233469_2_) {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema p_registerEntities_1_) {
      ...
      registerMob(p_registerEntities_1_, map, "minecraft:strider");
      return map;
   }
}