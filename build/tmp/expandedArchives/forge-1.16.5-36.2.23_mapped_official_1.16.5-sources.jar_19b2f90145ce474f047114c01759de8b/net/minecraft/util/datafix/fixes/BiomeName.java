...
public class BiomeName extends DataFix {
   ...
   public BiomeName(Schema p_i231463_1_, boolean p_i231463_2_, String p_i231463_3_, Map<String, String> p_i231463_4_) {
      ...
      this.biomes = p_i231463_4_;
      this.name = p_i231463_3_;
   }

   protected TypeRewriteRule makeRule() {
      Type<Pair<String, String>> type = DSL.named(TypeReferences.BIOME.typeName(), NamespacedSchema.namespacedString());
      if (!Objects.equals(type, this.getInputSchema().getType(TypeReferences.BIOME))) {
         throw new IllegalStateException("Biome type is not what was expected.");
      } else {
         return this.fixTypeEverywhere(this.name, type, (p_233380_1_) -> {
            return (p_233379_1_) -> {
               return p_233379_1_.mapSecond((p_233381_1_) -> {
                  return this.biomes.getOrDefault(p_233381_1_, p_233381_1_);
               });
            };
         });
      }
