...
public class VindicatorRenderer extends IllagerRenderer<VindicatorEntity> {
   ...
   public VindicatorRenderer(EntityRendererManager p_i47189_1_) {
      ...
      this.addLayer(new HeldItemLayer<VindicatorEntity, IllagerModel<VindicatorEntity>>(this) {
         public void render(MatrixStack p_225628_1_, IRenderTypeBuffer p_225628_2_, int p_225628_3_, VindicatorEntity p_225628_4_, float p_225628_5_, float p_225628_6_, float p_225628_7_, float p_225628_8_, float p_225628_9_, float p_225628_10_) {
   ...
   public ResourceLocation getTextureLocation(VindicatorEntity p_110775_1_) {
      return VINDICATOR;
   }
}