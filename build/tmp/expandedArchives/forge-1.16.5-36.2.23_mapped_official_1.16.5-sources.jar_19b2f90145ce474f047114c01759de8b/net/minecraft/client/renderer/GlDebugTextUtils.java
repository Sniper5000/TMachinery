...
public class GlDebugTextUtils {
   ...
   private static String printUnknownToken(int p_209245_0_) {
      return "Unknown (0x" + Integer.toHexString(p_209245_0_).toUpperCase() + ")";
   }

   private static String sourceToString(int p_209242_0_) {
      switch(p_209242_0_) {
      case 33350:
         return "API";
      case 33351:
      ...
      case 33355:
         return "OTHER";
      default:
         return printUnknownToken(p_209242_0_);
      }
   }

   private static String typeToString(int p_209248_0_) {
      switch(p_209248_0_) {
      case 33356:
         return "ERROR";
      case 33357:
      ...
      case 33384:
         return "MARKER";
      default:
         return printUnknownToken(p_209248_0_);
      }
   }

   private static String severityToString(int p_209246_0_) {
      switch(p_209246_0_) {
      case 33387:
         return "NOTIFICATION";
      case 37190:
      ...
      case 37192:
         return "LOW";
      default:
         return printUnknownToken(p_209246_0_);
      }
   }
   ...
   public static void enableDebugCallback(int p_209247_0_, boolean p_209247_1_) {
