...
public class SpectatorGui extends AbstractGui implements ISpectatorMenuRecipient {
   ...
   public void renderHotbar(MatrixStack p_238528_1_, float p_238528_2_) {
      if (this.menu != null) {
         ...
         if (f <= 0.0F) {
            ...
            this.renderPage(p_238528_1_, f, i, k, spectatordetails);
   ...
   protected void renderPage(MatrixStack p_238529_1_, float p_238529_2_, int p_238529_3_, int p_238529_4_, SpectatorDetails p_238529_5_) {
      ...
      for(int i = 0; i < 9; ++i) {
         this.renderSlot(p_238529_1_, i, this.minecraft.getWindow().getGuiScaledWidth() / 2 - 90 + i * 20 + 2, (float)(p_238529_4_ + 3), p_238529_2_, p_238529_5_.getItem(i));
      }
   ...
   private void renderSlot(MatrixStack p_238530_1_, int p_238530_2_, int p_238530_3_, float p_238530_4_, float p_238530_5_, ISpectatorMenuObject p_238530_6_) {
      ...
      if (p_238530_6_ != SpectatorMenu.EMPTY_SLOT) {
         ...
         p_238530_6_.renderIcon(p_238530_1_, f, i);
         ...
         if (i > 3 && p_238530_6_.isEnabled()) {
            ...
            this.minecraft.font.drawShadow(p_238530_1_, itextcomponent, (float)(p_238530_3_ + 19 - 2 - this.minecraft.font.width(itextcomponent)), p_238530_4_ + 6.0F + 3.0F, 16777215 + (i << 24));
         }
      }
   ...
   public void renderTooltip(MatrixStack p_238527_1_) {
      ...
      if (i > 3 && this.menu != null) {
         ...
         if (itextcomponent != null) {
            ...
            RenderSystem.enableBlend();
            RenderSystem.defaultBlendFunc();
            this.minecraft.font.drawShadow(p_238527_1_, itextcomponent, (float)j, (float)k, 16777215 + (i << 24));
            RenderSystem.disableBlend();
            RenderSystem.popMatrix();
         }
      }
